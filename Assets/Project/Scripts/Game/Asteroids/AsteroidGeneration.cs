...
public class AsteroidGeneration : MonoBehaviour
{
    ...
    [SerializeField] int l = 2;

    [SerializeField] int locationSize;
    [SerializeField] GameObject[] asteroids;
    [SerializeField] GameObject Planet;
    [SerializeField] float rangeOfSpawn;
    ...
    public void Generate()
    {
        ...
        mainSpawnedAsteroid = Instantiate(asteroids[(int) Mathf.Round(Random.value * (asteroids.Length - 1))],
        ...
        for (int i = 0; i <= locationSize; i++)
        {
            ...
            for (int j = 0; j <= amountOfNewAsteroids; j++)
            {
                ...
                tempObj = Instantiate(asteroids[(int) Mathf.Round(Random.value * (asteroids.Length - 1))], position,
                    Quaternion.identity);
